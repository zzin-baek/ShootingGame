...
HRESULT ProgressBar::init(int x, int y, int width, int height)
{
    ...
    _progressBarDown = IMAGEMANAGER->addImage("BarDown", "Resources/Image/UI/HpBarDown.bmp",
        0, 0, width, height, true, RGB(255, 0, 255));

    _progressBarUp = IMAGEMANAGER->addImage("BarUp", "Resources/Image/UI/HpBarUp.bmp",
        0, 0, width, height, true, RGB(255, 0, 255));
